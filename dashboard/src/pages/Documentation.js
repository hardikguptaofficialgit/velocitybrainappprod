...
const Documentation = () => {
  ...
  const docMap = {
    ...
    '/docs/token-efficiency': 'TOKEN_EFFICIENCY.md',
  ...
  const navigation = [
    ...
    },
    {
      ...
      subsections: ['Supported Pattern', 'What Should Happen Automatically', 'Product Promise'],
    },
    {
      id: 'architecture',
      title: 'Architecture',
    ...
    },
    {
      ...
      subsections: ['Without Velocity Brain', 'With Velocity Brain', 'Where Savings Come From'],
    },
    {
      id: 'advanced',
